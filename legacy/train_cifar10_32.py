...
if __name__ == "__main__":
    ...
    net = neural_network32.NeuralNetwork32().to(device)
    ...
    try:
        torch.save(net.state_dict(), "./traindata/model_weights32.pth")
    except:
        if not os.path.exists("./traindata"):
            os.makedirs("./traindata")
        open("./traindata/model_weights32.pth32", "w+").close()
        torch.save(net.state_dict(), "./traindata/model_weights32.pth")